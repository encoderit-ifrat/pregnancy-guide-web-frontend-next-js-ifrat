...
import CheckListItem from "./_component/CheckList";
...
export default function ChecklistsClientPage() {
  ...
  const handlePageChange = (page: number) => {
    ...
    router.push(`/checklistor?${params.toString()}`);
  };
                ...
                {user?.roles?.[0]?.name !== "partner" && (
                  <div className="flex flex-col sm:flex-row items-center justify-between flex-wrap mt-2 gap-4 lg:gap-2 lg:mt-0 w-full lg:w-auto">
                    ...
                    >
                      ...
                      <div className="size-6 lg:size-8 p-1.5 rounded-full bg-primary text-white flex items-center justify-center shrink-0">
                    ...
                    >
                      ...
                      <div className="size-6 lg:size-8 p-1.5 rounded-full bg-[#A97AEC] flex items-center justify-center shrink-0 shadow-sm">
                        <Sparkles
                          size={20}
                          strokeWidth={2}
