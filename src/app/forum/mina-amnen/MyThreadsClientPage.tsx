...
import MyThreadCard from "../_components/MyThreadCard";
import { useInfiniteQueryGetMyThreads } from "../_api/queries/useQueryGetThreads";
...
export default function MyThreadsClientPage() {
