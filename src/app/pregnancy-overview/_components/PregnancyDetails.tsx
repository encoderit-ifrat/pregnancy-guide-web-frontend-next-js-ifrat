      ...
      <section className="w-full max-w-7xl mx-auto my-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 px-4 md:px-6">
          ...
          <div className="border-t-10 border-t-primary rounded-lg bg-white px-6 py-4">
            <h3 className="text-primary-dark text-xl font-semibold mb-2">{pregnancyProgressInfo?.trimester}</h3>
            <h3 className="text-xl mb-4"><span className="text-primary-dark font-semibold">Been pregnant:</span>
              <span>{pregnancyProgressInfo?.week} weeks {pregnancyProgressInfo?.day} days</span>
            </h3>
            <div className="text-xl">
              <span className="text-primary">{pregnancyProgressInfo?.percentage || 0}%</span>
              Completed
            </div>
            {/*slider*/}
            <div>
          ...
          {/*card*/}
          <div className="border-t-10 border-t-primary rounded-lg bg-white px-6 py-4">
            <h3 className="text-primary-dark  text-xl font-semibold">Week-{pregnancyProgressInfo?.week} {userData.name}</h3>
          ...
          <div className="border-t-10 border-t-primary rounded-lg bg-white px-6 py-4 text-xl">
            <h3 className="mb-2"><span className="text-primary-dark font-semibold">Due Date:</span> {pregnancyProgressInfo?.dueDate}</h3>
            <h3><span className="text-primary-dark font-semibold">Days remaining to birth:</span> {pregnancyProgressInfo?.daysLeft} days</h3>
          </div>
        </div>
      </section>
  );
