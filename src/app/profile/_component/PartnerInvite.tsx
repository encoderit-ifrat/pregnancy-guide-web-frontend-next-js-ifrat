                    ...
                    <div className="flex flex-1 items-stretch h-11  border-[#A97AEC] rounded-lg border bg-white overflow-hidden">
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <button className="flex items-center justify-between gap-4 px-4 bg-white text-[#A179F2] hover:bg-[#FBF8FF] transition-colors min-w-28 text-sm md:text-base border-r border-[#A179F2]">
                                    {role}
