                ...
                answer_options.map((optionItem, idx) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                <div className={`flex items-center justify-center h-10 w-10 rounded-full ${isSelected ? 'bg-white text-primary' : 'bg-white border border-purple-100 text-primary'} font-medium`}>
                                    {getLetter(idx)}
                                </div>

                                <div className={`flex-1 text-left text-lg font-normal ${isSelected ? 'text-white' : 'text-foreground'}`}>
                                    {optionItem.content}
                                </div>
