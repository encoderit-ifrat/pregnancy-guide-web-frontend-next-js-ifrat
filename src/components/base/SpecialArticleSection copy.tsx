...
const SpecialArticleSectionCopy = ({ data }: TProps) => {
  ...
  return (
    <div className="relative px-4 sm:pb-7 lg:pb-15 lg:text-start section pb-10">
      {Boolean(data?.length) && (
        <>
...
export default SpecialArticleSectionCopy;
